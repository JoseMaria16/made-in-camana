        ...
        <div className='flex flex-col'>
            ...
            <div className='pb-3 flex gap-2'>
                <div className='flex flex-col w-max gap-2'>
                    ...
                    <input onChange={handleName} className='w-[200px] py-2 outline-none px-0 bg-gray-300 pl-4 placeholder-gray-600 rounded-md flex  ' type="text" name="" placeholder='Nombre..' id="" />
                </div>
                <div className='flex flex-col w-max gap-2'>
                    <label htmlFor="" className='text-center'>Al Lugar:</label>
                    <input type="text" name="" onChange={handleDom}  className='w-[200px] py-2 outline-none px-0 bg-gray-300 pl-4 placeholder-gray-600 rounded-md flex  ' placeholder='Domicilio' id="" />
                </div>
            </div>
            <MesageButon url={
                category === 'polos' || category === 'poleras' ? `https://wa.me/51969721673?text=Hola%2C%20Made%20in%20Caman%C3%A1%2C%20vengo%20desde%20tu%20pagina%20web%20a%20realizar%20el%20siguiente%20pedido%3A%20%0ACategoria%3A%20${categoriaSelect}%2C%0ANombre%3A%20${title}%2C%0ATalla%3A%20${talla}%2C%0AAl%20domicilio%3A%20${lugar}%2C%0AA%20nombre%20de%3A%20${name}%0AEspero%20su%20respuesta%20con%20ansias.`
